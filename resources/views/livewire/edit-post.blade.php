<div>
    ...
    <div class="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="sm:max-w-lg w-full bg-white rounded-xl shadow-sm">
            ...
            <form wire:submit.prevent="updatePost" class="mt-8 space-y-3" action="" method="POST">
                ...
                <div class="grid grid-cols-1 space-y-2">
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label class="relative flex flex-col rounded-lg @error('imagePost') border-red-500 @enderror border-4 border-dashed w-full h-max @if ($imagePost || $oldImagePost) p-1 @else p-5 @endif group text-center hover:cursor-pointer">
                            @if ($imagePost)
                                <img src="{{ $imagePost->temporaryUrl() }}" alt="">
                            @elseif ($oldImagePost)
                                <img src="/storage/{{ $oldImagePost }}" alt="">
                            @else
